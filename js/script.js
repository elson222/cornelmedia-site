...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        showNotification('Thank you! Your message has been prepared in your email client.');
    });
}
...
// Portfolio item click handling (for future lightbox implementation)
portfolioItems.forEach(item => {
    item.addEventListener('click', () => {
        // Placeholder for lightbox functionality
        console.log('Portfolio item clicked:', item.querySelector('h3').textContent);
        // You can add lightbox/modal functionality here in the future
    });
});
